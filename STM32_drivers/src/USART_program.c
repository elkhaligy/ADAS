...
/**
 * @brief Use DMA processor to transmit data from DR register to memory without CPU involvment
 * @param u8 USART_NUM
 */
void USART_enableReceiveWithDMA(u8 USART_NUM)
{
	SET_BIT(USART1_PER->CR3_REG, 6);
}

/**
 * @brief Use DMA processor to receive data from DR register to memory without CPU involvment
 * 
 * @param USART_NUM 
 */
void USART_enableTransmitWithDMA(u8 USART_NUM)
{
